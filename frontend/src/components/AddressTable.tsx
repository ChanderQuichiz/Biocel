...
export function AddressTable({userId, addresses, setAddresses}:{userId:number, addresses:Address[], setAddresses:React.Dispatch<React.SetStateAction<Address[]>>}) {
        ...
        {addresses.map((address) => (
          <TableRow key={address.addressId}>
            ...
            <div className="flex flex-row gap-2 ">
                          <AddressDialog userId={userId} icon={'https://cdn-icons-png.flaticon.com/128/10337/10337385.png'} setAddresses={setAddresses}/>
      ...
      <TableFooter>
        <TableRow>
          <TableCell  className="flex flex-row justify-between">Add new address 
            <AddressDialog userId={userId} icon={'https://cdn-icons-png.flaticon.com/128/11741/11741042.png'} setAddresses={setAddresses} />
            </TableCell>
        </TableRow>
      </TableFooter>
    </Table>
