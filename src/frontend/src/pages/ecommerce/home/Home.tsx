...
<div className="hover:bg-pink-600 text-white  z-10 group relative">
    <p className="hidden group-hover:block absolute inset-0 top-[40%] font-bold text-3xl ">Smartphones</p>
...
<div className="hover:bg-pink-600 text-white z-10 group relative">
    <p className="hidden group-hover:block absolute inset-0 top-[40%] font-bold  text-3xl ">Tablets</p>
...
<div className="hover:bg-pink-600 text-white z-10 group relative
">
  <p className="hidden group-hover:block absolute inset-0 top-[40%] font-bold text-3xl ">Audiculares</p>
...
<div className="hover:bg-pink-600 text-white z-10 group relative">
    <p className="hidden group-hover:block absolute inset-0 top-[40%] font-bold text-3xl ">Smartwatchs</p>
